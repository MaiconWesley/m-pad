    ...
    <div className="flex flex-col gap-6 p-4">
      <div className="bg-black/20 border border-white/10 rounded-xl p-4">
        ...
        <select 
          ...
          className="bg-[#0F1115] text-indigo-400 p-3 rounded-lg border border-white/10 w-full focus:border-indigo-500/50 outline-none"
        >
      ...
      <div className="bg-black/20 border border-white/10 rounded-xl px-4 py-3">
        ...
        <div className="flex items-center gap-3">
          ...
          />
          <button onClick={handleStop} className="shrink-0 px-5 py-3 bg-red-600 rounded-xl font-bold text-white hover:bg-red-700 transition-colors text-sm">PARAR</button>
        </div>
      </div>
